...
export function presentation(phase,name,track){
 ...
 if(phase==='playing'){
  ...
  return {...base,eyebrow:'LISTENING NOW',title:'Music is playing.',subtitle:'Enjoy the moment.',note:'Album recognition is not connected yet. Track details and artwork will appear here once it is ready.'};
 }
 return base;
}
