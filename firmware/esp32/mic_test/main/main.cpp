...
static audio::Pipeline pipeline;
...
extern "C" void app_main()
{
    ...
    while (true) {
        ...
        // ~11.7 updates/s. Latch events so unprinted frames cannot hide beats.
        if ((frame_number++ % 2) == 0) {
